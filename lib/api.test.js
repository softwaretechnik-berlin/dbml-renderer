...
dbmlFiles.forEach(function (_a) {
    ...
    formats.forEach(function (format) {
        ...
        (0, ava_1.default)("".concat(dbmlFile, " ").concat(format, " output is consistent"), function (t) { return __awaiter(void 0, void 0, void 0, function () {
            var expectedOutput, currentOutput, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        expectedOutput = (0, promises_1.readFile)("".concat(dbmlFile, ".").concat(format), "utf-8");
                        currentOutput = (0, promises_1.readFile)(outputFile(format), "utf-8");
