...
function peg$parse(input, options) {
    ...
    var peg$FAILED = {}, peg$startRuleFunctions = { File: peg$parseFile }, peg$startRuleFunction = peg$parseFile, peg$c0 = function (all) {
        ...
        return __spreadArray([head], tail).reduce(function (a, b) { return Object.assign(a, b); }, {});
    ...
    }, peg$c25 = /^[a-zA-Z_()0-9,]/, peg$c26 = peg$classExpectation([["a", "z"], ["A", "Z"], "_", "(", ")", ["0", "9"], ","], false, false), peg$c27 = function () {
        return text();
    }, peg$c28 = "indexes", peg$c29 = peg$literalExpectation("Indexes", true), peg$c30 = function (indices) {
        return { item: "indices", indices: indices };
    }, peg$c31 = function (head, index) {
        return index;
    }, peg$c32 = function (name) {
        return [name];
    }, peg$c33 = function (columns, settings) {
        return { columns: columns, settings: settings || {} };
    }, peg$c34 = "(", peg$c35 = peg$literalExpectation("(", false), peg$c36 = ",", peg$c37 = peg$literalExpectation(",", false), peg$c38 = function (head, entry) {
        return entry;
    }, peg$c39 = ")", peg$c40 = peg$literalExpectation(")", false), peg$c41 = function (entries) {
        return entries;
    }, peg$c42 = "[", peg$c43 = peg$literalExpectation("[", false), peg$c44 = "]", peg$c45 = peg$literalExpectation("]", false), peg$c46 = function (pairs) {
        return pairs;
    }, peg$c47 = function (head, setting) {
        return setting;
    }, peg$c48 = function (head, tail) {
        return __spreadArray([head], tail).reduce(function (a, b) { return Object.assign(a, b); }, {});
    }, peg$c49 = function (key, v) {
        return v;
    }, peg$c50 = function (key, value) {
        var _a;
        return _a = {}, _a[key] = value, _a;
    }, peg$c51 = /^[^,\]:]/, peg$c52 = peg$classExpectation([",", "]", ":"], true, false), peg$c53 = function () {
        return text().trim();
    }, peg$c54 = /^[^,\]]/, peg$c55 = peg$classExpectation([",", "]"], true, false), peg$c56 = "tablegroup", peg$c57 = peg$literalExpectation("TableGroup", true), peg$c58 = function (name, tables) {
        return { type: "group", name: name, tables: tables || [] };
    }, peg$c59 = "ref", peg$c60 = peg$literalExpectation("Ref", true), peg$c61 = ".", peg$c62 = peg$literalExpectation(".", false), peg$c63 = function (name, fromTable, fromColumns, cardinality, toTable, toColumns, settings) {
        return {
            type: "ref",
        ...
        return __spreadArray([head], tail).filter(function (i) { return i; });
    }, peg$c76 = function (name, settings) {
        return { name: name, settings: settings || {} };
    }, peg$c77 = /^[a-zA-Z_]/, peg$c78 = peg$classExpectation([["a", "z"], ["A", "Z"], "_"], false, false), peg$c79 = /^[a-zA-Z_0-9]/, peg$c80 = peg$classExpectation([["a", "z"], ["A", "Z"], "_", ["0", "9"]], false, false), peg$c81 = '"', peg$c82 = peg$literalExpectation('"', false), peg$c83 = /^[^"\n\r]/, peg$c84 = peg$classExpectation(['"', "\n", "\r"], true, false), peg$c85 = function (content) {
        return content.join("");
    }, peg$c86 = "'", peg$c87 = peg$literalExpectation("'", false), peg$c88 = /^[^'\n\r]/, peg$c89 = peg$classExpectation(["'", "\n", "\r"], true, false), peg$c90 = "'''", peg$c91 = peg$literalExpectation("'''", false), peg$c92 = function () {
        return "";
    }, peg$c93 = function (content) {
        return content;
    }, peg$c94 = peg$anyExpectation(), peg$c95 = function (head, c) {
        return c;
    }, peg$c96 = function (head, tail) {
        return __spreadArray([head], tail).join("");
    }, peg$c97 = "`", peg$c98 = peg$literalExpectation("`", false), peg$c99 = /^[^`]/, peg$c100 = peg$classExpectation(["`"], true, false), peg$c101 = "//", peg$c102 = peg$literalExpectation("//", false), peg$c103 = function (comment) {
                                                                ...
                                                                if (s15 !== peg$FAILED) {
                                                                    ...
                                                                    if (s16 !== peg$FAILED) {
                                                                        ...
                                                                        if (s17 !== peg$FAILED) {
                                                                            ...
                                                                            if (s18 !== peg$FAILED) {
                                                                                peg$savedPos = s0;
                                                                                s1 = peg$c63(s3, s7, s9, s11, s13, s15, s17);
                                                                                s0 = s1;
                                                                            }
                                                                            else {
                                                                                peg$currPos = s0;
