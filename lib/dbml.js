...
function peg$parse(input, options) {
    ...
    var peg$f34 = function (name, fromTable, fromColumns, cardinality, toTable, toColumns, settings) {
        return {
            type: "ref",
            cardinality: cardinality,
            fromTable: fromTable.length > 3 ? fromTable[0] + "." + fromTable[2] : fromTable[0],
