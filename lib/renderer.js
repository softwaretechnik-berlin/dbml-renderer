...
var TableRenderer = /** @class */ (function () {
    function TableRenderer(table) {
        ...
        (_a = this.columns).push.apply(_a, table.columns.map(function (column, i) { return new ColumnRowRenderer("f" + (i + 1), column, table); }));
    }
...
var EnumRenderer = /** @class */ (function () {
    ...
    EnumRenderer.prototype.toDot = function () {
        var _this = this;
        return "\"" + this.enumType.name + "\" [id=" + this.enumType.name + ";label=<<TABLE BORDER=\"2\" COLOR=\"#29235c\" CELLBORDER=\"1\" CELLSPACING=\"0\" CELLPADDING=\"10\">\n    <TR><TD PORT=\"f0\" WIDTH=\"150\" BGCOLOR=\"#29235c\"><font color=\"#ffffff\"><B>       " + this.enumType.name + "       </B></font></TD></TR>\n    " + this.enumType.values
