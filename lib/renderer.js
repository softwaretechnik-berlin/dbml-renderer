...
var TableNameRowRenderer = /** @class */ (function () {
    ...
    TableNameRowRenderer.prototype.toDot = function () {
        var _a;
        var tableColor = ((_a = this.table.settings) === null || _a === void 0 ? void 0 : _a.headercolor) === undefined
            ? "#1d71b8"
        ...
        return "<TR><TD PORT=\"".concat(this.port, "\" BGCOLOR=\"").concat(tableColor, "\"><font color=\"").concat(fontColor, "\"><B>       ").concat(this.table.name, "       </B></font></TD></TR>");
    };
...
var TableRenderer = /** @class */ (function () {
    ...
    TableRenderer.prototype.toDot = function () {
        var tooltip = this.table.options.Note === undefined
            ? ""
            : "tooltip=\"".concat(this.table.name, "\\n").concat(escapeString(this.table.options.Note), "\";");
        return "\"".concat(this.table.name, "\" [id=\"").concat(this.table.name, "\";").concat(tooltip, "label=<<TABLE BORDER=\"2\" COLOR=\"#29235c\" CELLBORDER=\"1\" CELLSPACING=\"0\" CELLPADDING=\"10\" >\n      ").concat(this.columns.map(function (column) { return column.toDot(); }).join("\n"), "\n    </TABLE>>];");
    };
        ...
        tables.forEach(function (table) {
            table.columns.forEach(function (column) {
                if ("ref" in column.settings) {
                    ...
                    var _a = ref.split(/([-<>])\s+(?:([\w\._]+)|"([^"\\\.]+)")\.(?:([\w_]+)|"([^"\\]+)")/), _ = _a[0], cardinality = _a[1], toTableUnquoted = _a[2], toTableQuoted = _a[3], toColumnUnquoted = _a[4], toColumnQuoted = _a[5];
                    extraRefs.push({
